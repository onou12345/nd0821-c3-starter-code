...
def test_load_data():
    ...
    and returns a DataFrame that is not empty and contains the
    expected columns.
    """
...
def test_classification_metrics():
    """
    Test the classification_metrics function
    to ensure that it returns a dictionary
    containing the accuracy, precision, recall
    and F1 score for the predictions.
    """
